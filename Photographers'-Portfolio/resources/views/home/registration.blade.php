                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input id="username" class="input--style-4" type="text" name="username" value="{{ old('username') }}">
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                                    <label class="label">Full Name</label>
                                    <input id="full_name" class="input--style-4" type="text" name="full_name" value="{{ old('full_name') }}">
                                </div>
                            </div>
                        </div>
                        <div class="row row-space">
